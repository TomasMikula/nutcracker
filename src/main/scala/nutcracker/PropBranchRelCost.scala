...
final class PropBranchRelCost[C: Monoid] extends Language {
  ...
  type Lang2[K[_], A] = CoproductK[RelLang, CostL, K, A]
  ...
  type State1[K[_]] = ProductK[RelDB, CostS, K]
