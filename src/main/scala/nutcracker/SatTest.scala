...
object SatTest extends App {
  ...
  val problem = for {
    ...
    ā3 <- not(a3)
    ā4 <- not(a4)
    _ <- atLeastOne(a1, a2, a3)
    _ <- atLeastOne(ā2, a3, ā4)
    _ <- atLeastOne(ā1, a3, a4)
    _ <- atLeastOne(ā1, ā3, ā4)
    _ <- atLeastOne(a2, a3, ā4)
    _ <- atLeastOne(a1, ā2, a4)
    _ <- atLeastOne(a1, a3, a4)
    _ <- atLeastOne(ā1, a2, ā3)
