...
object PropagationLang {
  ...
  case class DomTrigger[K[_], D, U, Δ](ref: DRef.Aux[D, U, Δ], f: D => (Option[K[Unit]], Option[(D, Δ) => Trigger[K]])) extends PropagationLang[K, Unit]
  ...
  def fetchVector[K[_], D, N <: Nat](refs: Sized[Vector[DRef[D]], N]): PropagationLang[K, Sized[Vector[D], N]] =
    FetchVector(refs)
  def domTrigger[K[_], D](ref: DRef[D])(f: D => (Option[K[Unit]], Option[(D, ref.Delta) => Trigger[K]])): PropagationLang[K, Unit] =
    DomTrigger[K, D, ref.Update, ref.Delta](ref, f)
  def selTrigger[K[_], L <: HList](sel: Sel[L])(f: L => Trigger[K]): PropagationLang[K, Unit] =
    SelTrigger(sel, f)
  ...
  def domTriggerF[F[_[_], _], D](ref: DRef[D])(f: D => (Option[FreeK[F, Unit]], Option[(D, ref.Delta) => Trigger[FreeK[F, ?]]]))(implicit inj: InjectK[PropagationLang, F]): FreeK[F, Unit] =
  ...
  def valTriggerF[F[_[_], _], D](ref: DRef[D])(f: D => Trigger[FreeK[F, ?]])(implicit inj: InjectK[PropagationLang, F]): FreeK[F, Unit] =
  ...
  def selTrigger2F[F[_[_], _], D1, D2](ref1: DRef[D1], ref2: DRef[D2])(f: (D1, D2) => Trigger[FreeK[F, ?]])(implicit inj: InjectK[PropagationLang, F]): FreeK[F, Unit] =
